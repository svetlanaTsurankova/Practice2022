...
import com.java.senla.controller.service.AddService;
import com.java.senla.controller.service.ChangeServicePrice;
import com.java.senla.controller.service.SortedServiceByPrice;
...
//room menu
        ...
        roomMenu.addMenuItem(new MenuItem("Sort rooms by price ", new SortingRoomOnCapacity(), roomMenu));
        roomMenu.addMenuItem(new MenuItem("Sort rooms by stars", new SortingRoomOnCapacity(), roomMenu));
...
//lodger menu
        ...
        lodgerMenu.addMenuItem(new MenuItem("SumPrice room ", new BillLodger(), lodgerMenu));
        lodgerMenu.addMenuItem(new MenuItem("list services lodger ", new ServicesLodger(), lodgerMenu));
