...
public class ManagerService implements IManagerService {
    ...
    public ManagerService() {
        services = new Service[]{services[0] = new Service(1, "cleaning", 5.26), services[1] = new Service(2, "wi-fi in the room", 6.25), services[2] = new Service(3, "food in the room", 7.63), services[3] = new Service(4, "car rental", 9.72), services[4] = new Service(5, "gym", 5.14),};
    }
